...
namespace TrainingFPT.DBContext
{
    public class TraningDBContext : DbContext
    {
        ...
        public DbSet<UsersDBContext> Users { get; set; }
        public DbSet<TraineeCourseDBContext> TraineeCourses { get; set; }
        public DbSet<TrainerTopicDBContext> TrainerTopics { get; set; }
    }
}
